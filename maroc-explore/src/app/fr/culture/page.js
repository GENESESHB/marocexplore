...
export const metadata = {
  ...
  title: 'Culture Marocaine & Amazigh - Maroc Explore',
  description: 'Plongez dans la riche tapisserie de la culture marocaine. Découvrez l\'héritage amazigh, l\'artisanat traditionnel, la musique et les traditions culinaires.',
};
    ...
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        <div className={styles.intro}>
          ...
          <p>
            La culture marocaine est un mélange unique d'influences arabes, amazighes, africaines et européennes. C'est une terre où l'histoire ancienne est vivante et où l'hospitalité est un devoir sacré. Nous vous invitons à explorer la profondeur et la beauté de notre héritage.
          </p>
        </div>
