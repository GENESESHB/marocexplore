...
export function generateMetadata() {
    const tour = toursActivitiesLibFr.find(t => t.slug === 'histoire-cinematographique-ouarzazate');
    ...
    return {
        ...
        keywords: ['Maroc Explore', 'Circuits Maroc 2026', tour.location, ...tour.highlights],
                alternates: {
            canonical: 'https://marocexplore.com/fr/blog/histoire-cinematographique-ouarzazate',
        },
        openGraph: {
