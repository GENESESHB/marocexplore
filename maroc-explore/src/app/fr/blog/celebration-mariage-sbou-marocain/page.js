...
export function generateMetadata() {
    const tour = toursActivitiesLibFr.find(t => t.slug === 'celebration-mariage-sbou-marocain');
    ...
    return {
        ...
        keywords: ['Maroc Explore', 'Circuits Maroc 2026', tour.location, ...tour.highlights],
                alternates: {
            canonical: 'https://marocexplore.com/fr/blog/celebration-mariage-sbou-marocain',
        },
        openGraph: {
