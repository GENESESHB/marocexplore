...
export default function SeoContentBlock({ tour }) {
  ...
  return (
    <div style={{ marginTop: '4rem', paddingTop: '3rem', borderTop: '1px solid #e5e7eb', color: '#374151', lineHeight: '1.8' }}>
        <h1 style={{ fontSize: '2rem', marginBottom: '1.5rem', fontWeight: 'bold', color: '#111827' }}>
